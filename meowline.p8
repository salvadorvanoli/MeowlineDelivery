...
-- Sistema de fondos
background_map = {}
default_background = 149 -- Sprite de fondo por defecto
...
solid_sprites = { 66, 72, 102 } -- Bloques totalmente solidos (desde todos los lados)
...
function initialize_background_map()
    ...
    -- Establecer fondos personalizados
    set_background_area(0, 0, 127, 30, 99)
end
...
function wrap_text(text, max_width)
    ...
    for word in all(words) do
        ...
        if #test_line * 4 <= max_width then -- 4 pixeles por caracter
...
function print_multiline(text, x, y, color, max_width)
    ...
    local line_height = 8 -- Altura entre lineas
...

...

