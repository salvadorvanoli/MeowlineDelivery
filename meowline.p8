...
solid_sprites = { 44, 62, 66, 71, 72, 73, 74, 75, 76, 77, 78, 95, 102 } -- Bloques totalmente solidos (desde todos los lados)
...
texts = {
        ...
        "presiona abajo para bajar plataformas",
...
function activate_button(button)
    ...
    for mx = 0, 127 do
        for my = 0, 30 do
            if mget(mx, my) == door_closed_sprite then
                -- Calcular distancia desde el boton hasta esta puerta
                local door_x = mx * 8
                local door_y = my * 8
                local distance = sqrt((door_x - button.x)^2 + (door_y - button.y)^2)
                
                -- SOLO considerar puertas que esten dentro del rango
    ...
    -- Si se encuentra una puerta dentro del rango, abrirla
    if closest_door then

        -- Marcar boton como activado
        ...
        if sprite_above == door_closed_sprite then
            -- El sprite encontrado es la parte INFERIOR de la puerta
            mset(found_x, found_y, 103)
            mset(found_x, found_y - 1, 104)
        else
            -- El sprite encontrado es la parte SUPERIOR de la puerta
    ...
    return false -- No se encontro puerta en el rango
end
...
function spawn_signs_from_map()
    ...
    for mx = 0, 127 do
        for my = 0, 30 do
            ...
            if sprite_id >= 87 and sprite_id <= 93 then
                local new_sign = {
                    x = mx * 8,
                    y = my * 8,
                    w = 8,
                    h = 8,
                    text_id = sprite_id - 86  -- sprite 87 = texto 1, 88 = texto 2, etc.
                }
                add(signs, new_sign)
            end
        end
...
function apply_skybox()
    -- Zona 1: Techos Populares - Skybox aleatorio
...

...

...
__map__

...

