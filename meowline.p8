...
damage_sprites = { 67 } -- Bloques que danian al jugador
...
-- Funcion para verificar si un sprite es un bloque que dania al jugador
...
-- Funcion para detectar bloques daniinos
...
function check_roomba_ground_collision(x, y, w, h)
    ...
    for cx = start_cx, end_cx do
        for cy = start_cy, end_cy do
            local sprite_id = mget(cx, cy)
            -- Las roombas pueden pararse en plataformas, bloques solidos Y bloques daniinos
...
function _update()
    ...
    if on_roomba then
        ...
        -- Si no esta sobre una roomba, aplicar gravedad y verificar colision vertical
    ...
    -- Verificar colision con bloques que danian al jugador
...

