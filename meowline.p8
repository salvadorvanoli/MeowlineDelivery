...
-- Sistema de fondos
background_map = {}
default_background_roofs = 149 -- Sprite de fondo por defecto para techos populares
...
solid_sprites = { 66, 72,73, 102 } -- Bloques totalmente solidos (desde todos los lados)
...
-- Sistema de botones
buttons = {}
button_range = 256  -- Radio de busqueda en pixeles (8 bloques)
...
function activate_button(button)
    ...
    local closest_distance = button_range + 1 
    ...
    for mx = 0, 127 do
        for my = 0, 30 do
            if mget(mx, my) == door_closed_sprite then
                ...
                -- Si esta dentro del rango y es la mas cercana
    ...
    -- Si se encuentra una puerta, determinar si es parte superior o inferior
...
function spawn_signs_from_map()
    ...
    for mx = 0, 127 do
        for my = 0, 30 do
            ...
            if sprite_id >= 87 and sprite_id <= 92 then
                local new_sign = {
                    x = mx * 8,
                    y = my * 8,
                    w = 8,
    ...
    if game_state == "cinematic" then
        ...
        if game_state == "playing" then
            ...
            elseif button_below then
                print("press x to activate", cam_x + 30, cam_y + 115, 7)
            elseif sign_below then
                -- Mostrar el texto del cartel
                local text = texts[sign_below.text_id]
                if text then
                    local num_lines = print_multiline_centered(text, cam_x, cam_y + 100, 7, 120)
                end
            end
...

...

