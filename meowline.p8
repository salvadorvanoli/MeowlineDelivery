    ...
    if game_state == "cinematic" then
        ...
        if game_state == "playing" then
            ...
            if not death_animation.active then
                local player_y_offset = 0 -- Offset vertical para el jugador
                ...
                if on_roomba then
                    ...
                    -- Si la roomba esta sobre agua, bajar al jugador 2 pixeles
                    if roomba_ground_sprite == 69 or roomba_ground_sprite == 70 then
                        player_y_offset = 5
                    end
                end
                
                spr(sprite_id, player.x - 2, player.y + player_y_offset, 2, 2, player.der)
            end
...
function draw_roombas()
    for roomba in all(roombas) do
        ...
        -- Verificar si la roomba esta sobre bloques de agua (sprites 69 o 70)
        local roomba_map_x = flr(roomba.x / 8)
        local roomba_map_y = flr((roomba.y + roomba.h) / 8) -- Verificar el bloque directamente debajo
        local ground_sprite = mget(roomba_map_x, roomba_map_y)
        local y_offset = 0

        -- Si esta sobre agua, usar sprites especiales 41-43
        if ground_sprite == 69 or ground_sprite == 70 then
            y_offset = 3
            if roomba.anim_frame == 0 then
                sprite_id = 41 -- Sprites 41-42
            else
                sprite_id = 43 -- Sprites 43-44
            end
        else
            -- Sprites normales en otros bloques
            if roomba.anim_frame == 0 then
        ...
        spr(sprite_id, roomba.x, roomba.y + y_offset, 2, 1)
    end
end
...
function update_playing()
    ...
    if btnp(2) and player.grounded then
        ...
        for bat in all(bats) do
            if bat.state == "idle" then
                local dx = (bat.x + bat.w / 2) - (player.x + player.w / 2)
                local dy = (bat.y + bat.h / 2) - (player.y + player.h / 2)
...

...

...
__gff__

...

...

...

...

...
010200002402025021270212f0002b0212c0212d0212e0212f0212f0052f00032000030000000037000370002f0002f0002f0002f000000003300004000000000000000000000000000000000000000000000000
...
011e0000180121801218012180121f0121f0121f0121f0121e0121e0121e0121e0121e0121e0121e0121e012180121801218012180121b0121b0121b0121b0121a0121a0121a0121a0121a0121a0121a01200000
...
1303000017314292151750417314292151950417314292151c5041731429215000001731429215000001731429215000001731429215175041731429215195041731429215000001731429215000001731429215
...

__music__
03 080a4344
01 1f424344
00 21424344
