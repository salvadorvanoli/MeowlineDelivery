...
function activate_button(button)
    ...
    local closest_distance = button_range + 1 -- Inicializar con distancia mayor al rango
    ...
    -- Si encontramos una puerta, determinar si es parte superior o inferior
    if closest_door then
        local found_x = closest_door.x
        local found_y = closest_door.y
        
        -- Verificar si el sprite de arriba tambien es una puerta (sprite 102)
        ...
        return true -- Indica que se abrio una puerta
    end
...

...

